 ...
 * @param win
 */
export declare function init(opts: PrebootOptions, win?: PrebootWindow): void;
/**
 ...
 * @param win
 */
export declare function waitUntilReady(data: PrebootData, win?: PrebootWindow): void;
/**
 ...
 */
export declare function createOverlay(document: Document): Element | undefined;
/**
 ...
 */
export declare function getAppRoots(doc: Document, opts: PrebootOptions): ServerClientRoot[];
/**
 ...
 */
export declare function createListenHandler(prebootData: PrebootData, eventSelector: EventSelector, appData: PrebootAppData, node: Element): EventListener;
/**
