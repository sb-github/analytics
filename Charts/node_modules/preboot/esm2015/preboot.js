import { APP_BOOTSTRAP_LISTENER, Inject, InjectionToken, NgModule, Optional, PLATFORM_ID, RendererFactory2, ViewEncapsulation } from '@angular/core';
...
class EventReplayer {
    ...
    cleanup(prebootData) {
        ...
        const /** @type {?} */ completeEvent = new Event('PrebootComplete');
    ...
    findClientNode(serverNodeContext) {
        ...
        for (const /** @type {?} */ clientNode of Array.from(clientNodes)) {
...
function waitUntilReady(data, win) {
    const /** @type {?} */ theWindow = /** @type {?} */ ((win || window));
    const /** @type {?} */ doc = /** @type {?} */ ((theWindow.document || {}));
    if (doc.body) {
        start(data);
    }
    else {
...
function start(prebootData, win) {
    ...
    const /** @type {?} */ document = /** @type {?} */ ((theWindow.document || {}));
    const /** @type {?} */ opts = prebootData.opts || (/** @type {?} */ ({}));
    const /** @type {?} */ eventSelectors = opts.eventSelectors || [];
    ...
    const /** @type {?} */ appRoots = prebootData.opts ? getAppRoots(document, prebootData.opts) : [];
    // for each app root
...
function addScript(doc, rendererFactory, recordOpts, nonce, platformId) {
    ...
    const /** @type {?} */ res = () => {
        if (isPlatformServer(platformId)) {
            const /** @type {?} */ inlineCode = getInlinePrebootCode(recordOpts);
            const /** @type {?} */ renderType = { id: '-1', encapsulation: ViewEncapsulation.None, styles: [], data: {} };
            const /** @type {?} */ renderer = rendererFactory.createRenderer(doc, renderType);
